...
Findings:
•	Average Response Time: 45–60 ms
•	Throughput: 80–120 requests per second
•	Error Rate: 0%
...
Findings:
•	Peak Users Reached: 300
•	Average Response Time: 200–350 ms
•	Max Response Time: 1200 ms
•	Error Rate: 1% (timeouts and connection failures)
Interpretation:
Under heavy load, the application begins to show strain:
•	Server response time increased drastically beyond 250 users.
•	Timeouts were observed, indicating worker threads or server capacity saturation.
•	Throughput plateaued around 300 RPS, revealing the server’s maximum capacity.
...
Findings:
•	Duration: 10 minutes
•	Average Response Time: 50–70 ms
